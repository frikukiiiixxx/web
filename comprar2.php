    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <div class="talla-buttons">
                <button type="submit" name="talla" value="S" class="btn-talla">S</button>
                <button type="submit" name="talla" value="M" class="btn-talla">M</button>
                <button type="submit" name="talla" value="L" class="btn-talla">L</button>
                <button type="submit" name="talla" value="XL" class="btn-talla">XL</button>
            </div>
